...
def generate(env):
    ...
    env['LINK'] = 'g++.exe'
    env['_LINKCOM'] = '$($LINK_KWRAPPER$) $LINK -o ${TARGETS[0].abspath} $LINKFLAGS -Wl,-T,custom_i386.lnk $_LIBDIRFLAGS -Lcommon_scripts/site_scons/cgt_sysfiles/mingw32 -Xlinker -Map=${TARGETS[1].abspath} -Xlinker -( $_LIBFLAGS $LINKED_LIBS -lstdc++ ${SOURCES.abspath} -Xlinker -)'
